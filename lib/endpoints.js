export const API_BASE = process.env.NEXT_PUBLIC_API_BASE_URL || "http://13.127.244.245:8000/api/v1";
export const MEDIA_BASE = process.env.NEXT_PUBLIC_MEDIA_BASE_URL || "http://13.127.244.245:8000/media";
